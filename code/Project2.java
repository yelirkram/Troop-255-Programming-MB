...
public class Project2{
    ...
    public static void main(final String args[]) {
        ...
        // is an integer but we do not assume that it is greater than or equal to 0. If 
        // the number entered is less than 0, prompt the user again until the number 
        // entered is greater than or equal to 0.
        // Once you have a number that is greater than or equal to 0, prompt the user for
        // a second number. Ensure the second number is greater than or equal to 0. Once
        // you have two numbers, call the printPrime function with those values.
        ...
        // accept user input. It is available in the util package/library, which we imported above
        // We pass it an argument, System.in which is a class that tells the Scanner it
        // will read input from a command line. We could tell Scanner that we will read in a
    ...
    public static void printPrime(int first, int second) {
        ...
        // prime numbers strictly between those two numbers (i.e. not including those two numbers).
        ...
        if (second < first) {
            ...
            // Reverse their order
            int tempNum = first; // Hold the larger number in a temporary variable
